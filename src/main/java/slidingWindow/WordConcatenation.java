...
public class WordConcatenation {
	...
	// the time complexity will be O(N * M * Len) where 'N' is the number of
	// characters in the given string, 'M' is the total number of words, and 'Len' is the length of a word
