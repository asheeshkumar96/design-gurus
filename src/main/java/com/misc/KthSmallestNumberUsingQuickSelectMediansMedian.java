...
public class KthSmallestNumberUsingQuickSelectMediansMedian {
	...
	private static int medianOfMedians(int[] nums, int low, int high) {
		...
		for(int i = 0; i < numOfPartitions; i++) { 
			...
			Arrays.sort(nums, partitionStart, partitionStart + 5); // sort the 5 element array
	...
	public static void main(String[] args) {
		int result = KthSmallestNumberUsingQuickSelectMediansMedian.findKthSmallestNumber(new int[] { 1, 5, 12, 2, 11, 5}, 3);
		System.out.println("Kth smallest number is: " + result);
		
		result = KthSmallestNumberUsingQuickSelectMediansMedian.findKthSmallestNumber(new int[] { 1, 5, 12, 2, 11, 5}, 4);
		System.out.println("Kth smallest number is: " + result);
		
		result = KthSmallestNumberUsingQuickSelectMediansMedian.findKthSmallestNumber(new int[] { 5, 12, 11, -1, 12 }, 3);
		System.out.println("Kth smallest number is: " + result);
	}
