...
public class KthSmallestNumberUsingQuickSelect {
	...
	public static void main(String[] args) {
		int result = KthSmallestNumberUsingQuickSelect.findKthSmallestNumber(new int[] { 1, 5, 12, 2, 11, 5}, 3);
		System.out.println("Kth smallest number is: " + result);
		
		result = KthSmallestNumberUsingQuickSelect.findKthSmallestNumber(new int[] { 1, 5, 12, 2, 11, 5}, 4);
		System.out.println("Kth smallest number is: " + result);
		
		result = KthSmallestNumberUsingQuickSelect.findKthSmallestNumber(new int[] { 5, 12, 11, -1, 12 }, 3);
		System.out.println("Kth smallest number is: " + result);
	}
