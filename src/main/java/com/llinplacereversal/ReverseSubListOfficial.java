...
public class ReverseSubListOfficial {
	...
	public static ListNode reverse(ListNode head, int p, int q) {
		...
		// we are interested in three parts of LinkedList, part before index 'p', part between 'p' and 'q'
		...
		} else { // this means p == 1 i.e., we are changing the first node (head) of the linked list
			head = previous;
		}
	...
	public static void main(String[] args) {
		...
		ListNode result = ReverseSubListOfficial.reverse(head, 2, 4);
