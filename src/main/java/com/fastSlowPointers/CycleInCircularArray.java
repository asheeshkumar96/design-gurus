...
public class CycleInCircularArray {
  ...
  public static boolean loopExist(int[] arr) {
  ...
  public static void main(String[] args) {
    System.out.println(CycleInCircularArray.loopExist(new int[] {1, 2, -1, 2, 2}));
    System.out.println(CycleInCircularArray.loopExist(new int[] {2, 2, -1, 2}));
    System.out.println(CycleInCircularArray.loopExist(new int[] {2, 1, -1, 2}));
  }
}
