...
public class ShortestWindowSort {
	...
	// official, O(N) time complexity, O(1) space complexity
	public static int sort(int[] arr) {
		...
		// find the first number out of sorint orer from the end
		...
		System.out.println("hight Index = " + high + ", low index=" + low);
