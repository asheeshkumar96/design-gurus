...
public class AllTaskSchedulingOrders {
	...
	// official, very hard to understand the recursive part
	public static void printOrders(int tasks, int[][] prerequisites) {
		...
		System.out.println("sored Order=" + sortedOrder);
	...
	private static void printAllTopologicalSorts(HashMap<Integer, List<Integer>> graph,
		...
		// if sorted order doesn't contain all tasks, either we've a cyclic dependency
		// between tasks, or
